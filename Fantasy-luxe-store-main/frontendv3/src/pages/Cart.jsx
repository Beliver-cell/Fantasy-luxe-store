        ...
        for (const itemColor in cartItems[items][item]) {
          if (cartItems[items][item][itemColor] > 0) {
            tempData.push({
              ...
              size: item,
              color: itemColor,
              quantity: cartItems[items][item][itemColor],
            });
          }
        }
      }
    ...
    return (
      <div className="border-t pt-14">
        ...
        <EmptyState
          ...
          message="Add some items to your cart and they'll appear here. Let's find something beautiful for you!"
          buttonText="Start Shopping"
          recommendationTitle="Popular picks for you"
        />
      </div>
    );
  }
            ...
            >
              <div className="flex items-start gap-6">
                ...
                <img
                  ...
                  className="w-4 mt-2 mr-4 sm:w-5 cursor-pointer hover:opacity-70"
                  src={assets.bin_icon}
                  alt=""
                />
              </div>

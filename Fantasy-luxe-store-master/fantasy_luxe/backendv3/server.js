...
app.get('/sitemap.xml', async (req, res) => {
  try {
    ...
    const baseUrl = process.env.FRONTEND_URL || 'https://fantasyluxe.store';
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"
  ...
  <url>
    <loc>${escapeXml(baseUrl)}/collections?category=Women</loc>
    <lastmod>${today}</lastmod>
    <changefreq>daily</changefreq>
    <priority>0.8</priority>
  </url>
  <url>
    <loc>${escapeXml(baseUrl)}/collections?type=Topwear</loc>
    <lastmod>${today}</lastmod>
    <changefreq>daily</changefreq>
